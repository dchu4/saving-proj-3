...
//        }
    ...
    public void OnNewSearchResult(TargetFinder.TargetSearchResult targetSearchResult)
    {
		...
		if (targetSearchResult.MetaData == null) {
			...
			Application.OpenURL(targetSearchResult.MetaData);
//			JSONObject productData = new JSONObject(targetSearchResult.MetaData);
//			Debug.Log (productData["product_name"]);
//			Debug.Log (productData["product_number"]);
//			Debug.Log (productData["retailer"]);
//			Debug.Log (productData["url"]);
			StopScanning ();
		}
